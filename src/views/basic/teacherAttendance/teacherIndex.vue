  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column
        ...
        align="center"
        prop="xxspdzpArr"
        :width="flexColumnWidth('xxspdzpArr', teacherAttendanceList)"
      >
        <template slot-scope="scope">
        ...
        <el-col :span="12">
          ...
          >
            ...
            <el-upload
              ...
              :file-list="fileList"
            >
              <el-button size="small" :disabled="fileDisable" type="primary"
                >点击上传</el-button
              >
...
export default {
  ...
  methods: {
      beforeFile(file) {
      this.fileForm.renameFileName = "老师请假—" +file.name
    },
    // 查询学校列表
    getSchoolList() {
    ...
    //确认收假
    handleShouJia() {
      this.handleShenpiTools(
        3,
        5,
        "提示：只有【审核通过-待确认收假】状态的数据才可收假！"
      ); // 3=审核通过-待确认收假; 5=确认收假
    },
    // 处理审批的公共方法
