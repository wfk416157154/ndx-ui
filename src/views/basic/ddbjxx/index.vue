<template>
    <div class="dd-class-info">
        <el-form :inline="true" :model="supervisorClassInfoForm" class="demo-form-inline">
            <el-form-item label="老师">
                <el-input v-model="supervisorClassInfoForm.lsxm" placeholder="老师"></el-input>
            </el-form-item>
            <el-form-item>
                <el-button type="primary" @click="getList">查询</el-button>
                <el-button type="danger" class="el-icon-refresh-right" @click="updateClassPlanClick">更新教学计划列表的数据</el-button>
            </el-form-item>
        </el-form>
        ...
        <el-table :data="supervisorClassInfoData" border style="width: 100%">
            ...
            <el-table-column prop="address" label="班级信息">
                <template slot-scope="scope">
                    <el-link type="primary" @click="toPages('ddbjcj', scope.row.bjid)">班级成绩</el-link>
                    <br />
                    <el-link type="primary" @click="toPages('xscj', scope.row.bjid)">学生成绩</el-link>
                    <br />
                    <el-link type="primary" @click="toPages('bjkb', scope.row.bjid)">班级课表</el-link>
                </template>
            </el-table-column>
        </el-table>

        <pagination v-show="total > 0" :total="total" :page.sync="supervisorClassInfoForm.pageNum" :limit.sync="supervisorClassInfoForm.pageSize" @pagination="getList" />
    </div>
</template>
