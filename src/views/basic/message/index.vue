  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="消息确认方式" prop="xxqrlx" label-width="100px" >
        <el-select v-model="queryParams.xxqrlx" placeholder="请选择消息确认方式" clearable size="small">
          <el-option
    ...
    <!--<el-col :span="1.5">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['basic:message:export']"
        >导出</el-button>
      </el-col>-->
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :height="$root.tableHeight" border :data="messageList" @selection-change="handleSelectionChange">
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="接收人" prop="jsrArr">
          <el-select
            v-model="xqid"
            filterable
            placeholder="请选择校区名称"
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('basic/message/export', {
        ...this.queryParams
      ...
      /** 下载模板操作 */
      importTemplate() {
          this.download('basic/message/importTemplate', {
              ...this.queryParams
