<template>
  <div class="teacher-allocation">
    ...
    <div class="train-box">
      <h1>培训主题</h1>
      <!-- 主题列表 -->
      <el-table style="width: 100%;font-size : 18px" border :data="themeList" @row-click.self="getProject">
    ...
    <div v-show="projectShow" class="train-box">
      <h1>培训项目</h1>
      <!-- 项目列表 -->
      <el-table  border :data="projectList" @row-click.self="getContent" style="width: 100%;font-size : 18px">
