  ...
  <div style="width : 100%; height : 100%; padding : 40px; box-sizing : border-box">
    <el-form ref="suspensionListForm" :model="suspensionListForm" :inline="true" label-width="80px">
      <el-form-item label="学校">
        <el-select v-model="suspensionListForm.region" placeholder="请选择负责人">
    ...
    <el-table :data="offShiftListList" border style="width: 100%">
      <el-table-column prop="date" label="学校" width="180"></el-table-column>
      <el-table-column prop="name" label="班级" width="180"></el-table-column>
      <el-table-column prop="address" label="老师"></el-table-column>
      <el-table-column prop="address" label="学生姓名"></el-table-column>
      <el-table-column prop="address" label="休学时间"></el-table-column>
      <el-table-column prop="address" label="审核文件"></el-table-column>
