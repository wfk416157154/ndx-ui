          ...
          <tr>
            ...
            <td class="clearfix">
              <div style="float : left">
                <el-radio v-model="radio" label="1">只退班</el-radio>
                <el-radio v-model="radio" label="2">退班退费</el-radio>
              </div>
              <div style="margin-top : 40px">
                <el-input type="textarea" :rows="4" placeholder="请输入退班原因" v-model="textarea"></el-input>
              </div>
            </td>
          </tr>
          <tr>
            ...
            <td class="clearfix">
              <div style="float : left">
                <el-radio v-model="radio" label="1">已上交</el-radio>
                <el-radio v-model="radio" label="2">丢失</el-radio>
                <el-radio v-model="radio" label="3">未签署</el-radio>
              </div>
          ...
          <tr>
            ...
            <td class="clearfix">
              <div style="float : left">
                <el-radio v-model="radio" label="1">已上交</el-radio>
                <el-radio v-model="radio" label="2">丢失</el-radio>
                <el-radio v-model="radio" label="3">未开据</el-radio>
              </div>
              <div style="width : 180px;height : 180px; margin-top : 30px">
                <el-upload
                  :action="upload.imgUrl"
