  ...
  <div style="width: 100%; height: 100%; padding: 40px; box-sizing: border-box">
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button type="success" @click="queryShenpi('2,3,4,5,6')"
          >已审批</el-button
        >
        <el-button icon="el-icon-refresh" @click="resetQuery">重置</el-button>
        <el-button type="info" icon="el-icon-bottom" @click="exportTuibanData"
          >导出退班数据</el-button
        >
      </el-form-item>
    </el-form>
      ...
      <el-table-column label="操作" width="260px" align="center">
        <template slot-scope="scope">
          <el-button
            ...
            v-if="1 != scope.row.tblx && 1 == scope.row.shzt"
            @click="chushenEditPage(scope.row)"
            >审核</el-button
          >
          <el-button
            size="mini"
            type="success"
            icon="el-icon-s-flag"
            v-if="6 != scope.row.shzt"
            @click="jiesuanEdit(scope.row)"
            >结算</el-button
          >
        </template>
      </el-table-column>
    ...
    <el-dialog title="初审" :visible.sync="dialogVisible" width="30%">
      <div>
        <el-form ref="chushenRefForm" :model="chushenForm" label-width="80px">
          <el-form-item label="退还金额">
            <el-input
              placeholder="请输入内容"
              v-model="chushenForm.thje"
            ></el-input>
          </el-form-item>
