<template>
  <div class="app-container">
    ...
    <el-table
      ...
      border
      :data="teacherTasklistList"
      @selection-change="handleSelectionChange"
    >
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="主键" v-if="false" align="center" prop="id" />
      ...
      <el-table-column label="第三四周" align="center" prop="threeWeek">
        <template slot-scope="scope">
          <span v-for="(item,index) in scope.row.threeWeek.split(',')" :key="index">
      ...
      <el-table-column label="录入或修改人ID" v-if="false" align="center" prop="userId" />
      <el-table-column
        v-if="false"
        label="操作"
        align="center"
