    ...
    <div class="wrap-right-item">
      <vxe-toolbar ref="xToolbar" :loading="loading">
        <template #buttons>
          ...
          <vxe-button
            ...
            content="更新学期数据"
            @click="addOrUpdateQueryTermData"
          ></vxe-button>
        </template>
      </vxe-toolbar>
      <vxe-table
      ...
      >
        ...
        <vxe-column
          field="ssyf"
          title="月份"
          :edit-render="{name: 'input', attrs: {type: 'text', placeholder: '请输入月份'}}"
        ></vxe-column>
        <vxe-column
          field="yxz"
          title="有效周"
          :edit-render="{name: 'input', attrs: {type: 'text', placeholder: '请输入有效周'}}"
        ></vxe-column>
        <vxe-column
          field="jincheng"
          title="进程"
          :edit-render="{name: 'input', attrs: {type: 'text', placeholder: '请输入进程'}}"
        ></vxe-column>
        ...
        <vxe-column
          field="remark"
          title="备注"
          :edit-render="{name: 'input', attrs: {type: 'text', placeholder: '请输入备注'}}"
        ></vxe-column>
        <vxe-column
          field="ksrq"
          title="开始日期"
        ...
        <vxe-column
          field="jzrq"
          title="截止日期"
          :edit-render="{name: '$input', props: {type: 'date', placeholder: '请选择日期'},events:{change:jzrqOnchange}}"
        ></vxe-column>
...
export default {
  data() {
    return {
      ...
      validRules: {
        xqmc: [{ required: true, message: "学期名称必须选择" }],
        ssyf: [{ required: true, message: "所属月份必须填写" }],
        yxz: [{ required: true, message: "有效周必须填写" }],
        jincheng: [{ required: true, message: "进程必须填写" }],
        ksrq: [{ required: true, message: "开始日期必须填写" }],
        jzrq: [{ required: true, message: "截止日期必须填写" }]
      },
      xueqiMap: [],
      xueqiDict: [],
      teachingCourseType: [],
