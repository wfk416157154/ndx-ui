<template>
    <div class="InventoryRegistration">
        ...
        <el-table :data="inventoryRegistrationData" border style="width: 100%">
            ...
            <el-table-column prop="stock" label="库存数量" width="200px"></el-table-column>
                ...
                <template slot-scope="scope">
                    <el-popover placement="right" width="700px" trigger="click">
                        <el-table :data="detailsData" border>
                            <el-table-column width="150px" property="registerDate" label="日期"></el-table-column>
                            <el-table-column
                                ...
                                label="收入/支出"
                            ></el-table-column>
                            <el-table-column width="100px" property="registerCount" label="数量"></el-table-column>
                        ...
                        <el-button slot="reference" @click="viewDetails(scope.row.id)">查看详情</el-button>
                    </el-popover>
                    <el-button
                        style="margin-left: 20px"
                        @click="editInventoryRegistration(scope.row)"
                    >编辑</el-button>
                    <el-button type="warning" @click="handleExportDetails(scope.row.id)">导出收/出详情</el-button>
                </template>
            </el-table-column>
        </el-table>
