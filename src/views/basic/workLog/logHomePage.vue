        ...
        <li v-for="(item,index) in allLogs" :key="index">
          ...
          <div class="img-list __float">
            <div class="jswsImg">
              ...
              <el-radio v-if="dataRoleWeightId > 50" v-model="item.isJswsHg" label="1" @change="jianYan(true,item)">合格
              </el-radio>
              <el-radio v-if="dataRoleWeightId > 50" v-model="item.isJswsHg" label="0" @change="jianYan(false,item)">
                不合格
              </el-radio>
