    ...
    <div class="Log-home-page">
        <el-form ref="queryForm" :inline="true" :model="queryParams">
            ...
            <el-form-item label="日志日期" prop="sj">
                <el-date-picker v-model="queryParams.sj" type="daterange" format="yyyy-MM-dd" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期"></el-date-picker>
            </el-form-item>
            <el-form-item label="排序方式" prop="orderChoose">
                <el-radio-group v-model="queryParams.orderChoose">
                    <el-radio label="0" border @change="getList">升序</el-radio>
                    <el-radio label="1" border @change="getList">倒序</el-radio>
                </el-radio-group>
            </el-form-item>
      ...
      >填写日志</el-button>-->
        ...
        <div class="wrap-log-list">
            <ul>
                <li v-for="(item, index) in allLogs" :key="index">
                    ...
                    " @click="toFileVideo(item.spFileList)">视频</el-button>
                                    <el-button type="warning" size="mini" plain @click="toDetails(item.teacherWorkLogId)">查看详情</el-button>
                                    <el-button type="success" size="mini" plain @click="downloadZipFile(item.teacherWorkLogId)">下载压缩包</el-button>
                                </div>
                            </div>
        ...
        <el-dialog title="视频" :visible.sync="dialogVideoFileVisible">
            <div class="wrap-box">
                ...
                <div class="video-box">
                    <video width="100%" ref="video" height="100%" :src="videoUrl" autoplay="autoplay" style="opacity: 1" controls></video>
                </div>
            </div>
