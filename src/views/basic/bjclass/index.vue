<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="info" icon="el-icon-upload2" size="mini" v-has-permi="['basic:bjclass:importData']"
      ...
      <el-col :span="1.5">
        <el-button type="info" icon="el-icon-upload" :disabled="single" size="mini" @click="onUploadPhoto">查看照片
        </el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table border v-loading="loading" :height="$root.tableHeight" :data="bjclassList"
