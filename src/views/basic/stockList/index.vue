    ...
    <div class="stockList">
        <el-form :inline="true" :model="stockForm" class="demo-form-inline">
            ...
            <el-form-item>
                ...
                <el-button type="warning" @click="handleExportStockData">导出</el-button>
            </el-form-item>
        </el-form>
        <el-table :data="stockData" border style="width: 100%">
            ...
            <el-table-column
                ...
                width="180"
            ></el-table-column>
            <el-table-column prop="bookName" label="资料名称" width="180"></el-table-column>
        ...
        <el-dialog title="登记" :visible.sync="handleRegisterVisible">
            <table style="width: 100%" border="1" cellspacing="0">
              ...
              "
                    ...
                    <tr>
                        <td style="padding: 20px; box-sizing: border-box; text-align: center">资料名称</td>
                  ...
                  item, index
                            ...
                            >
                                ...
                                <el-input-number
                                    ...
                                    label="描述文字"
                                ></el-input-number>
                                <el-button class="el-icon-delete" @click="dropDataName(index)"></el-button>
                                <el-tag
                    ...
                    <tr>
                        <td style="padding: 20px; box-sizing: border-box; text-align: center">资料出处</td>
                        <td style="padding: 20px; box-sizing: border-box">
                            <el-input
                                type="textarea"
                                :rows="4"
                    ...
                    <tr>
                        <td style="padding: 20px; box-sizing: border-box; text-align: center">备注</td>
                        <td style="padding: 20px; box-sizing: border-box">
...
export default {
    ...
    methods: {
        ...
        handleRegisterSubmit() {
            ...
            if (
                this.handleRegisterForm.basicBookRegisterDetailList.length >= 1
            ) {
                for (
                    let i = 0;
                    i <
                    this.handleRegisterForm.basicBookRegisterDetailList.length;
                    i++
                ) {
                    if (
        ...
        getBookDetails(id, index) {
            bookDetalis(id).then((res) => {
                this.handleRegisterForm.basicBookRegisterDetailList[
                    index
        ...
        registerTypeFormat(row) {
            return this.selectDictLabel(
                this.bookRegisterTpye,
                row.registerType
            );
        },
        registerTypeDataFormat(row) {
            return this.selectDictLabel(
                this.bookRegisterData,
                row.registerTypeData
            );
        },
        dropDataName(index) {
            this.handleRegisterForm.basicBookRegisterDetailList.splice(
                index,
                1
            );
        },
