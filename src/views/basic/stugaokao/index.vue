<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="stugaokaoList" @selection-change="handleSelectionChange">
...
<script>
import { listStugaokao, getStugaokao, delStugaokao, addStugaokao, updateStugaokao } from "@/api/basic/stugaokao";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除学生高考成绩编号为"' + ids + '"的数据项?', "警告", {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('basic/stugaokao/export', {
        ...this.queryParams
      }, `学生高考成绩.xlsx`)
    },
      ...
      /** 下载模板操作 */
      importTemplate() {
          this.download('basic/stugaokao/importTemplate', {
              ...this.queryParams
          }, `学生高考成绩-导入模板.xlsx`)
      },
      // 文件上传中处理
