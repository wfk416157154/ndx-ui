<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :height="$root.tableHeight" border :data="trainVideoList" @selection-change="handleSelectionChange">
...
<script>
import { listTrainVideo, getTrainVideo, delTrainVideo, addTrainVideo, updateTrainVideo } from "@/api/basic/trainVideo";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('basic/trainVideo/export', {
        ...this.queryParams
      ...
      /** 下载模板操作 */
      importTemplate() {
          this.download('basic/trainVideo/importTemplate', {
              ...this.queryParams
