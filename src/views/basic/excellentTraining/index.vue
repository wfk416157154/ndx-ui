<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :height="$root.tableHeight" border :data="excellentTrainingList" @selection-change="handleSelectionChange">
...
<script>
import { listExcellentTraining, getExcellentTraining, delExcellentTraining, addExcellentTraining, updateExcellentTraining } from "@/api/basic/excellentTraining";
