<template>
  <div class="app-container">
    <el-form
      ...
      label-width="68px"
    >
      <el-form-item label="审核人" prop="rybjid">
        <el-select v-model="queryParams.rybjid" placeholder="请选择审核人" filterable>
          <el-option
            :label="item.rybjmc"
            :value="item.id"
      ...
      <el-form-item label="数据状态" prop="lsid">
        <el-select v-model="queryParams.lsid" filterable placeholder="请选择数据状态">
          <el-option
      ...
      <el-form-item label="教案审核状态" prop="lsid" label-width="120px">
        <el-select v-model="queryParams.lsid" filterable placeholder="请选择教案审核状态">
          <el-option
            v-for="item in teacherListOption"
            :key="item.id"
            :label="item.lsxm"
    ...
    >
      <el-table-column label="审核人" align="center" prop="rybjmc" />
      <el-table-column label="分配周" align="center" prop="lsxm" />
