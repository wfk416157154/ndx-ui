<template>
    <div class="app-container">
        ...
        <el-table style="width: 100%;font-size : 18px" :height="$root.tableHeight" border :data="lessonPreparationDataList">
            ...
            <el-table-column label="教案审核状态" align="center" prop="jashzt" :formatter="getPrepareLessonAuditStatus" />
            <el-table-column label="教案状态" align="center" prop="shzt" :formatter="getPreparelesoonsStatus" />
