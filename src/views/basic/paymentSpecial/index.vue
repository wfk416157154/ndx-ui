<template>
  <div class="app-container">
    ...
    <el-table style="width: 100%;font-size : 18px" v-loading="loading" :height="$root.tableHeight" border :data="paymentSpecialList" @selection-change="handleSelectionChange">
