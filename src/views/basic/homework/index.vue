<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :height="$root.tableHeight" border :data="homeworkList" @selection-change="handleSelectionChange">
...
<script>
import { listHomework, getHomework, delHomework, addHomework, updateHomework } from "@/api/basic/homework";
