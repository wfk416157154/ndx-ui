        ...
        <template slot-scope="scope">
          ...
          <el-popover placement="right" width="400" trigger="click">
            <el-table :data="gridData">
              <el-table-column width="150" prop="shr" label="审核人"></el-table-column>
              <el-table-column width="100" prop="shsj" label="审核时间"></el-table-column>
              <el-table-column width="300" prop="shyj" label="审核意见"></el-table-column>
              <el-table-column width="300" prop="shzt" label="审核状态"></el-table-column>
            </el-table>
            <el-button style="margin : 0 10px" slot="reference" size="mini">查看流程</el-button>
          </el-popover>
...
export default {
  ...
  methods: {
    ...
    handleView() {
      this.getConfigKey("handle-market").then(res => {
        this.$router.push({
          path: res.msg
        });
      });
