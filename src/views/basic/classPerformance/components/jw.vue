    ...
    <div id="statisticalChartTtem">
        <div class="wrap-statisticalChartTtem">
            <el-form ref="form" :inline="true" :model="form" label-width="100px">
                <el-form-item label="校区" prop="xqid">
                    <el-select width="100px" height="“10px" v-model="form.xqid" filterable @change="getSchoolId" placeholder="请选择校区">
                        <el-option v-for="(item, index) in getListSchool" :label="item.xxmc" :value="item.id" :key="index"></el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="日语班级" prop="bjid">
                    <el-select filterable width="100px" height="“10px" @change="getClassId" v-model="form.bjid" placeholder="请选择班级">
                        <el-option v-for="(item, index) in getBjClass" :label="item.rybjmc" :value="item.id" :key="index"></el-option>
                    </el-select>
                </el-form-item>
                ...
                <el-form-item label="考试范围" v-if="false" label-width="120px" prop="ksfw">
                    <el-select width="100px" height="“10px" v-model="form.ksfw" placeholder="请选择考试范围">
                        <el-option v-for="(item, index) in getExaminationPaper" :label="item.ksfw" :value="item.id" :key="index"></el-option>
                    </el-select>
                </el-form-item>
                ...
                <el-form-item>
                    <el-button v-for="item in studentGradeTypeList" :key="item.dictValue" type="primary" class="el-btn" plain @click="getAchievement(item.dictValue)">{{ item.dictLabel }}</el-button>
                </el-form-item>
                <el-form-item label="考试时间">
                    <div class="block">
                        <el-date-picker v-model="dcForm.sjArr" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" value-format="yyyy-MM-dd">
                        </el-date-picker>
        ...
        <ul class="wrap-achievement clearfix">
            <li v-for="(item, index) in listClassGradeItem" :key="index">
                ...
                <div class="wrap-right">
                    <div class="wrap-chart">
                        <div :id="index" v-if="true" style="width: 90%; height: 500px; display: inline-block"></div>
                        <div class="chart-nav">
            ...
            <div class="wrap-pagination">
                <el-pagination @current-change="handleCurrentChange" :current-page.sync="currentPage1" :page-size="10" layout="total, prev, pager, next" :total="pagination.total"></el-pagination>
            </div>
        </ul>
    </div>
</template>
