        ...
        <div class="wrap-statisticalChartTtem">
            <el-form ref="queryForm" :inline="true" :model="form" label-width="100px">
                <el-form-item label="日语班级" prop="bjid" label-width="80px">
                    <el-select width="100px" height="“10px" @change="getClassId" v-model="form.bjid" filterable placeholder="请选择班级">
                ...
                <el-form-item>
                    <el-tooltip :content="'分制: ' + form.studentGradeType" placement="top">
                        <el-switch v-model="form.studentGradeType" @change="getAchievement(form.studentGradeType)" active-color="#13ce66" inactive-color="#ff4949" active-value="100" inactive-value="150"></el-switch>
                    </el-tooltip>
                </el-form-item>
            </el-form>
        </div>
                ...
                for (let i = 0; i < item.length; i++) {
                    ...
                    if (item[i].everyTimeGradeInfoQueries.length != 0) {
                        for (let j = 0; j < item[i].everyTimeGradeInfoQueries.length; j++) {
                            ...
                            this.obj[i].series[0].name = `(${item[i].rybj})班-最高分(${item[i].everyTimeGradeInfoQueries[j].kscjMax});最低分(${item[i].everyTimeGradeInfoQueries[j].kscjMax});考试人数${item[i].everyTimeGradeInfoQueries[j].ksrs};平均分`;
                        }
