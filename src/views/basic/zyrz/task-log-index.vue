    ...
    <div class="app-container">
      ...
      <el-col :span="1.5">
        ...
        >
            ...
            <el-table-column label="作业内容" align="center" width="350px" prop="zynr">
                <template slot-scope="scope">
                    <div ref="zyrn" class="zyrn" v-html="scope.row.zynr"></div>
                </template>
            </el-table-column>
    ...
    methods: {
        ...
        getList() {
            ...
            listHomework(this.queryParams).then((response) => {
                ...
                this.loading = false;
                this.$nextTick(() => {
                    this.domReset(document.getElementsByClassName("zyrn"));
                });
            });
        },
        domReset(domList) {
