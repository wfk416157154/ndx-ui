    ...
    <div class="app-container">
        <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
            <el-form-item label="校区名称" prop="xqmc">
                <el-select v-model="queryParams.xqmc" :disabled="xqmcDisabled" placeholder="请选择校区名称" @change="xqmcOnChange" filterable>
                    <el-option v-for="item in selectXqmc" :key="item.id" :label="item.xxmc" :value="item.id"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="日语班级" prop="kzzd1">
                <el-select v-model="queryParams.kzzd1" :disabled="rybjDisabled" placeholder="请选择日语班级" @change="rybjOnChange" filterable>
            ...
            <el-form-item label="学生姓名" prop="xsbh">
                <el-select v-model="queryParams.xsbh" filterable remote reserve-keyword :disabled="xsbhDisabled" :remote-method="chooseStudents" placeholder="请选择/搜索学生">
                    <el-option v-for="item in studentsList" :key="item.id" :label="item.xsxm" :value="item.xsbh"></el-option>
                </el-select>
            </el-form-item>
        ...
        <el-row :gutter="10" class="mb8">
            ...
            <el-col :span="1.5">
                <el-button type="info" plain icon="el-icon-right" size="mini" @click="tongbuData" v-hasPermi="['basic:stugrade:syncKsmcToExaminationPaper']">同步考试名称至考卷表</el-button>
            </el-col>
