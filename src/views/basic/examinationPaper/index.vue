<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" size="mini" @click="changeStatus(1)"
          >已发送</el-button
        >
        <el-button type="primary" size="mini" @click="changeStatus(0)"
          >未发送</el-button
        >
      </el-col>
      <right-toolbar
      ...
      >
        <template slot-scope="scope">
          <el-button
            ...
            >上传试卷</el-button
          >
          <el-button size="mini" type="text" @click="deleteSubmit(scope.row)"
            >删除</el-button
          >
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    beforeFile(file) {
      this.fileForm.renameFileName = "发送试卷—" + file.name;
    },
    /** 查询考卷列表 */
    getList() {
      this.loading = true;
