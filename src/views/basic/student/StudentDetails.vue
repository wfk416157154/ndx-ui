  ...
  <el-collapse v-model="activeNames" >
    <el-collapse-item  name="1" >
      ...
      <el-form class="wrap-el-form" ref="form" :model="form"  label-width="80px">
        <el-col :span="3">
          <el-avatar shape="square" style="margin-left: 40px;margin-top: 25px" :size="100" :src="form.xstx"></el-avatar>
        </el-col>
        <el-col :span="21">
          <div style="font-family: 微软雅黑">
            <span>{{form.xsxm}}</span>
            <el-divider direction="vertical"></el-divider>
            <span><dict-tag style="display: inline-block" :options="xbOptions" :value="form.xb"/></span>
            <el-divider direction="vertical"></el-divider>
            ...
            <el-divider direction="vertical"></el-divider>
            <span>选科：<dict-tag style="display: inline-block" :options="xkTypeOptions" :value="form.xk"/></span>
            <el-divider direction="vertical"></el-divider>
