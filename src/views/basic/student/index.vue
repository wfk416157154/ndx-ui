    ...
    <div class="app-container">
        ...
        >
            ...
            <el-form-item label-width="100px" label="是否特长生" prop="sftcs">
                <el-select
                    v-model="queryParams.sftcs"
                    placeholder="请选择是否特长生"
                    clearable
                    size="small"
                >
                    <el-option
        ...
        >
            ...
            <el-table-column label="学生头像" :fixed="true" align="center" prop="xstx">
                <template slot-scope="scope">
                    <el-image
                        v-if="scope.row.xstx!=null&&scope.row.xstx!=''"
                        style="width : 80px; hieght : 80px"
                        :src="scope.row.xstx"
                        :preview-src-list="previewPhoto(scope.row.xstx)"
                    />
                </template>
            </el-table-column>
        ...
        <el-dialog :title="title" :visible.sync="open" width="900px" append-to-body>
            ...
            >
              ...
              >{{dict.dictLabel}}</el-radio>
                ...
                <el-col :span="12">
                    <el-form-item label-width="100px" label="状态" prop="zhfs">
...
export default {
    ...
    created() {
        ...
        this.getDicts("stu_status").then((response) => {
                ...
                if (res.code == 200) {
                    this.$router.push({
                        path:
                            res.msg +
                            "?query=" +
                            JSON.stringify(this.paramsList[0]),
                    });
                }
            });
        },
