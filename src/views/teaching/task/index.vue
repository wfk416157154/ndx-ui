  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="阶段教学任务" prop="jdjxrw">
        <el-input
          v-model="queryParams.jdjxrw"
          placeholder="请输入阶段教学任务"
          clearable
          size="small"
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['teaching:task:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['teaching:task:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listTask, getTask, delTask, addTask, updateTask } from "@/api/teaching/task";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除教学计划模板-教学任务编号为"' + ids + '"的数据项?', "警告", {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('teaching/task/export', {
        ...this.queryParams
      }, `teaching_task.xlsx`)
    }
  }
