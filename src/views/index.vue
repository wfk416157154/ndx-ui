<template>
  <div class="app-container home">
    ...
    <el-dialog title="消息通知" :visible.sync="dialogTableVisible">
      <el-table v-loading="loading" :height="$root.tableHeight" width="90%" border :data="messageList">
      ...
      <el-dialog
        ...
        <el-form ref="form" :model="form"  label-width="80px">
          ...
          <el-form-item label="消息内容" prop="xxnr">
            <div v-html="form.xxnr" style="padding: 10px;">
            </div>
          </el-form-item>
          ...
          <el-form-item label="回复内容" prop="messageHfnr" v-if="messageConfirmStatus=='3'||messageConfirmStatus=='2'" >
            <el-input type="textarea" v-model="form.messageHfnr" :disabled="messageConfirmStatus=='2'" maxlength="400" placeholder="请输入"/>
          </el-form-item>
        </el-form>
        <div slot="footer" class="dialog-footer">
          <el-button type="primary" v-prevent-re-click @click="submitForm" v-if="messageConfirmStatus=='3'">回复</el-button>
