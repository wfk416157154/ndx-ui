<template>
  <div class="wrap-examine">
    ...
    <el-table :data="examineTableData" border style="width: 100%">
      ...
      <el-table-column prop="rybjmc" label="班级名称"> </el-table-column>
      <el-table-column prop="xqmc" label="校区名称"> </el-table-column>
      <el-table-column prop="name" label="姓名/称呼"> </el-table-column>
      <el-table-column prop="userId" label="学号/老师id"> </el-table-column>
      <el-table-column prop="phone" label="手机号"> </el-table-column>
      <el-table-column prop="parentTel" label="家长手机号"> </el-table-column>
  ...
  methods: {
    ...
    sendMsg(openId) {
      ...
      this.getConfigKey("wecharServerUrl").then((resp) => {
        checkRoleSendMsg(resp.msg, obj);
      });
    },
    exportWxUser() {
      this.download("basic/wxUser/wxUserExport", {}, `微信用户信息.xlsx`);
    },
  },
};
</script>
